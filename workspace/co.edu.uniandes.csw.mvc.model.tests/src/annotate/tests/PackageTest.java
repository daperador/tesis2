 ...
 * @generated
 */
public class PackageTest extends AnnotableTest {
	 ...
	 */
	@Override
	protected annotate.Package getFixture() {
		return (annotate.Package)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(AnnotateFactory.eINSTANCE.createPackage());
	}
