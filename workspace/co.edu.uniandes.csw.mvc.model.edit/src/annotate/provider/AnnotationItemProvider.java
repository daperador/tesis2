...
/**
 * This is the item provider adapter for a {@link annotate.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_annotationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_annotationType_feature", "_UI_Annotation_type"),
				 AnnotatePackage.Literals.ANNOTATION__ANNOTATION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnnotatePackage.Literals.ANNOTATION__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnnotatePackage.Literals.ANNOTATION__ATTRIBUTES,
				 AnnotateFactory.eINSTANCE.createAnnotationAttribute()));
	}
