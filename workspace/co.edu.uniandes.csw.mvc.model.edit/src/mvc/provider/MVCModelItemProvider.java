	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MVCModel_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MVCModel_components_feature", "_UI_MVCModel_type"),
	...
	protected void addEntitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MVCModel_entities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MVCModel_entities_feature", "_UI_MVCModel_type"),
				 MvcPackage.Literals.MVC_MODEL__ENTITIES,
				 true,
				 false,
				 true,
				 null,
