		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPackageAccess().getAnnotationsAssignment_4_2(), "rule__Package__AnnotationsAssignment_4_2");
					put(grammarAccess.getPackageAccess().getAnnotationsAssignment_4_3_1(), "rule__Package__AnnotationsAssignment_4_3_1");
					put(grammarAccess.getPackageAccess().getTypesAssignment_5_2(), "rule__Package__TypesAssignment_5_2");
					put(grammarAccess.getPackageAccess().getTypesAssignment_5_3_1(), "rule__Package__TypesAssignment_5_3_1");
					put(grammarAccess.getPackageAccess().getAnnotationTypesAssignment_6_2(), "rule__Package__AnnotationTypesAssignment_6_2");
					put(grammarAccess.getPackageAccess().getAnnotationTypesAssignment_6_3_1(), "rule__Package__AnnotationTypesAssignment_6_3_1");
