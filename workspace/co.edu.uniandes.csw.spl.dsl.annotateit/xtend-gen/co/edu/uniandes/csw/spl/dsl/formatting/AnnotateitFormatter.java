 ...
 * generated by Xtext
 */
package co.edu.uniandes.csw.spl.dsl.formatting;
...
public class AnnotateitFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private AnnotateitGrammarAccess _annotateitGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._annotateitGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._annotateitGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._annotateitGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._annotateitGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._annotateitGrammarAccess.getML_COMMENTRule();
