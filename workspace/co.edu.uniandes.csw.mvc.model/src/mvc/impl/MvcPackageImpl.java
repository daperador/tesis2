...
public class MvcPackageImpl extends EPackageImpl implements MvcPackage {
	 ...
	 * @generated
	 */
	public EReference getMVCModel_Models() {
		return (EReference)mvcModelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMVCModel_Views() {
	 ...
	 * @generated
	 */
	public EReference getMVCModel_Events() {
		return (EReference)mvcModelEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getMVCModel_Version() {
		return (EAttribute)mvcModelEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getMVCModel_Controllers() {
		return (EReference)mvcModelEClass.getEStructuralFeatures().get(5);
	}
	...
	public EReference getMVCModel_Components() {
		return (EReference)mvcModelEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getMVCModel_ImportURI() {
		return (EAttribute)mvcModelEClass.getEStructuralFeatures().get(7);
	}
	...
	public void createPackageContents() {
		...
		createEReference(mvcModelEClass, MVC_MODEL__MODELS);
		createEReference(mvcModelEClass, MVC_MODEL__VIEWS);
		createEReference(mvcModelEClass, MVC_MODEL__EVENTS);
		createEAttribute(mvcModelEClass, MVC_MODEL__VERSION);
		createEReference(mvcModelEClass, MVC_MODEL__CONTROLLERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getAssociation_Source(), this.getEntity(), null, "source", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMVCModel_Models(), this.getModel(), null, "models", null, 0, -1, MVCModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMVCModel_Views(), this.getView(), null, "views", null, 0, -1, MVCModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMVCModel_Events(), this.getEvent(), null, "events", null, 0, -1, MVCModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMVCModel_Controllers(), this.getController(), null, "controllers", null, 0, -1, MVCModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponent_Controllers(), this.getController(), null, "controllers", null, 1, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
