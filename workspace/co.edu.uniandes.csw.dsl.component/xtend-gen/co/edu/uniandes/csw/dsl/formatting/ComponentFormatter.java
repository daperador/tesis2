 ...
 * generated by Xtext
 */
package co.edu.uniandes.csw.dsl.formatting;
...
public class ComponentFormatter extends AbstractDeclarativeFormatter {
  ...
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._componentGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._componentGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._componentGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._componentGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._componentGrammarAccess.getML_COMMENTRule();
