 ...
 ******************************************************************************/
package co.edu.uniandes.ticsw.spl.mtcflow.standalone;
...
import com.mtcflow.engine.acceleo.ACCELEOTechnologyManager;
...
public class MTCStandaloneUtils {
	...
	public static void initializeRegistry() {
		...
		MTCFlow.TechnologyManagerRegistry.INSTANCE.put("mtl", new ACCELEOTechnologyManager());
	...
	public static MTCChoreographer startMTC(IProject project, String bundleName, String mtcName, Transformation transformation, List<Model> startModels, List<String> tagList, HashMap<String, Object> variables) {
		...
		try {
			...
			if (console == null) {
				console = new EclipseConsole(findConsole("SPL - Generator"));
			}
			// show the console
			...
			view.display(findConsole("SPL - Generator"));
